...
<body style=" background-color: rgba(250, 250, 250, 0.2);">
    ...
    <form action="../../Controller/Produto/produto_saida.php" method="POST">
        ...
        <div class="selecao">
            <select class="form-control" name=opcao>
                <option value="0">Devolução ao Fornecedor</option>
                <option value="1">Tranferência entre lojas</option>
                <option value="2">Remessa para Concertos</option>
                <option value="3">Ajuste de estoque</option>
                <option value="4">Uso e consumo interno</option>
